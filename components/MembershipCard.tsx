...
export default function MembershipCard({ membership }: { membership: IMembership }) {
  return (
    <>
      <div style={{ borderColor: 'black' }} className='w-96 p-4 h-96 bg-base-100  border-[8px] grid text-black rounded-2xl mx-auto shadow-lg dark:shadow-none dark:bg-gray-800'>
