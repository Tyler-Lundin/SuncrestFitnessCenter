  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className=''>
      <div className='grid gap-4'>
        ...
        <input {...register("name", { required: true })} className='border-2 border-black rounded-md p-2' />
        ...
        <input {...register("email", { required: true })} className='border-2 border-black rounded-md p-2' />
        ...
        <input {...register("phone", { required: true })} className='border-2 border-black rounded-md p-2' />
        ...
        <textarea {...register("message", { required: true })} className='border-2 border-black rounded-md p-2' />
